...
(custom-set-variables
 ...
 '(markdown-command "npx marked --gfm")
 '(package-selected-packages
   (quote
    (avy diminish counsel-projectile org-evil lsp-haskell yasnippet flycheck-elm nix-mode purescript-mode psc-ide elm-mode typescript-mode lsp-ui lsp-mode rust-mode flx-ido sunburn-theme zenburn-theme color-theme-sanityinc-solarized color-theme-modern color-theme-sanityinc-solarizedcolor-theme-sanityfinc-solarized sanityinc-solarized-dark frame-fns use-package)))
